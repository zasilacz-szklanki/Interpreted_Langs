            ...
            <div className="p-4 flex flex-col flex-1 gap-2">
                ...
                <div className="mt-4 flex gap-2">
                    <Link
                        ...
                        className="flex-1 flex items-center justify-center text-center text-sm font-medium py-2 px-4 rounded bg-utility hover:bg-secondary-hover transition-colors"
                    >
                        Details
                    </Link>
